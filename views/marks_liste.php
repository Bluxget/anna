...
<form action="?module=marks&action=ajouter" method="post">
	...
	<input required type="number" name="idFormer" placeholder="N° jury" /><br/>
...
<?php foreach($datas['marks'] as $mark): ?>
	<tr>
		...
		<td>
			...
			<form action="?module=marks&action=supprimer" method="POST">
